...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers(HttpMethod.POST,"/Users/check/authkey/**").authenticated()
                .antMatchers(HttpMethod.POST,"/Users/check/phonekey/**").authenticated()
                .antMatchers(HttpMethod.POST, "/Users/user").authenticated()
